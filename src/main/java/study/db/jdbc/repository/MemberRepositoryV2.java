...
@Slf4j
@Repository
public class MemberRepositoryV2 implements MemberRepositoryForTransaction {
    ...
    @Override
    public Optional<Member> findById(Connection conn, String memberId) {
...
//                throw new NoSuchElementException("member not found memberId=" + memberId);
    ...
    @Override
    public void update(Connection conn , String id , int money) {
